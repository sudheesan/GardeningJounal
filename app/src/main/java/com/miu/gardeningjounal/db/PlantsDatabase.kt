...
import com.miu.gardeningjounal.db.PlantsDao
...
abstract class PlantsDatabase():RoomDatabase() { // Must Inherit from RoomDatabase
    abstract fun getPlantsDao() : PlantsDao // Need this function to get the Dao for the Entity
    // Build RoomDB
    companion object {
